...
for pkg in xorg-x11-drv-void openafs-kpasswd puppet-3.6.2-1.el6sat facter-1.7.6-2.el6sat ruby-shadow-1.4.1-13.el6_4 ruby-augeas-0.4.1-1.el6_4 libganglia astronomy-bookmarks; do
